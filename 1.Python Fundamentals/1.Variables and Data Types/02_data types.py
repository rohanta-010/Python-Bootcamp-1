...
print(is_completed) # if we just type (ic), vs code will auto suggest the variable name
print(type(is_completed))

## In Python, everything is an object, and categories of objects are called classes.